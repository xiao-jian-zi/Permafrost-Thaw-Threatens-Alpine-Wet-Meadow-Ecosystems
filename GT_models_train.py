...
joblib.dump(svm_model, './gt-svm_model.pkl')
joblib.dump(rf_model, './gt-rf_model.pkl')
joblib.dump(gbdt_model, './gt-gbdt_model.pkl')

loaded_model = joblib.load('./gt-svm_model.pkl')
